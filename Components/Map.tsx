            ...
            renderItem={(itemdata)=>{
                return(
                    <View style={styles.location_data}>
                        ...
                        <Text style={styles.location_name}  numberOfLines={1}>{itemdata.item.formatted}</Text>
                        <Text style={styles.time}>{context.date[itemdata.index]},{context.time[itemdata.index]}</Text>
                        </View>
                        <View>
                        <Button 
